...
Future<void> _getCallLogEntries() async {
    ...
    var calls = await CallLog.query(
      limit: 5,
      sort: true,
      // Arama tarihine göre sıralama
      orderBy: CallLogOrderBy.date,
    );

    // Firestore'a kaydedin
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    CollectionReference callLogs = firestore.collection('call_logs');
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            trailing: Text('${call.duration} seconds'),
          );
        },
      ),
    );

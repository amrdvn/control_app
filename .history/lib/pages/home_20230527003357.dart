...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance
      ...
      listenToRestrictions(); // Kısıtlamaları kontrol et
  }

void listenToRestrictions() {
  ...
  FirebaseFirestore.instance
    ...
    for (QueryDocumentSnapshot doc in snapshot.docs) {
      String appName = doc.data()['uygulama_adi'];
    ...
    for (Application app in apps) {
      ...
      if (querySnapshot.docs.isEmpty) {
        await logsCollection
            ...
            .collection('uygulama_kisit')
            .doc(packageName)
            .set({'uygulama_adi': appName,uygulama_adi': appName, 'kisit': 0});
      }
    }

...
Future<void> uygulamaKisitKontrol() async {
  try {
    String appName = await getTopPackageName(); // Ekranda açık olan uygulamanın paket adını alır
...
Future<String> getTopPackageName() async {
  if (Platform.isAndroid) {
    final result = await ProcessText.getTopPackageName();
    return result.packageName;
  } else {
    throw UnsupportedError('Bu özellik sadece Android\'de desteklenmektedir.');
  }
}

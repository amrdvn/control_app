...
//arama kaydı
Future<void>void aramaKaydiGonder() async {
  await CallLog.query();
...
Future<void> kayitlariGonder() async {
  ...
  if (auth.currentUser != null) {
    ...
    // Konum kayıtlarını gönder
    await sonkonumBilgisiGonder(uid, firestore);

    // Arama kayıtlarını gönder
    await aramaKaydiGonder(uid, firestore);

    // Uygulama istatistiklerini gönder
    await uygulama_istatistik(uid, firestore);
  }
}

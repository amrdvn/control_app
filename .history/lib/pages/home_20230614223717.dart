...
static const platform = const MethodChannel('myapp/screenLock');

  Future<void> lockScreen(Duration duration) async {
    try {
      await platform.invokeMethod('lockScreen', {'duration': duration.inSeconds});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ActionChip(
                  label: Text("Tıkla"),
                  onPressed: (){lockScreen(Duration(minutes: 5));},
                  ),
            ],
          ),
        ),
...
// Uygulama Kaldırma Kısmı //
  ...
  void telKilitle(Duration duration) {
    LockDeviceService.lockDevice(duration);

...
Future<void> initUsage() async {
  ...
  DateTime startDate = DateTime.now().subtract(Duration(days: 30)); // Son 30 günü kapsayan bir zaman aralığı

    List<EventUsageInfo> queryEvents =
        await UsageStats.queryEvents(startDate, endDate);
queryEvents.sort((a, b) => b.timeStamp.compareTo(a.timeStamp));
  List<EventUsageInfo> last10Events = queryEvents.take(10).toList();
    this.setState(() {

...
import 'package:control_app/model/bildirim.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  BildirimServisi _bildirimServisi = BildirimServisi(); // BildirimServisi'ni burada oluşturuyoruz.
  ...
  void initState() {
    super.initState();
     FirebaseFirestore.instance
      ...
      setState(() {});
      _bildirimServisi.kayitEt(user!.uid); // BildirimServisi'ni kullanarak token'ı kaydediyoruz.
    });

    _bildirimServisi.bildirimleriBaslat(); // BildirimServisi'ni kullanarak bildirimleri dinlemeye başlıyoruz.
  }

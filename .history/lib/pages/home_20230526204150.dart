...
void checkAndShowAlert() async {
  ...
  try {
    // UsageStatsManager'ı kullanarak şu anki açık uygulamayı al
    UsageStatsManager usageStatsManager = UsageStatsManager();
    List<UsageStats> usageStatsList =
        await usageStatsManager.queryUsageStats(
    ...
    if (usageStatsList.isNotEmpty) {
      UsageStats currentAppUsage = usageStatsList.last;
      String currentApp = currentAppUsage.packageName;

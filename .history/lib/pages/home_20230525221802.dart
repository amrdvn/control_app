...
import 'package:control_apps/device_apps.dart';
...
void uygulama_listesini_gonder() async {
  List<String>? uygulamaListesi = await UygulamaListesi.getUygulamaListesi();
  if (uygulamaListesi == null) {
    return;
  }
  CollectionReference logsCollection = FirebaseFirestore.instance.collection("logs");
  DocumentReference logsDoc = logsCollection.doc(uid);
  Map<String, dynamic> uygulamaListesiMap = {};
  for (String uygulamaAdi in uygulamaListesi) {
    uygulamaListesiMap[uygulamaAdi] = false;
  }

  logsDoc.set(
    {
      "uygulama_listesi": uygulamaListesiMap,
    },

...
@override
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    if (_lifecycleState == AppLifecycleState.resumed) {
      checkAndPrintDebugMessage();
    }
  }

  Future<String> getBundleIdentifier() async {
    if (Platform.isAndroid) {
      return 'com.example.app'; // Replace with your Android bundle identifier
    } else if (Platform.isIOS) {
      final MethodChannel platform = MethodChannel('com.example.app/package');
      final String bundleIdentifier =
          await platform.invokeMethod('getBundleIdentifier');
  ...
  Future<String> getPackageName() async {
    if (Platform.isAndroid) {
      final String packageName =
          await MethodChannel('com.example.app/package')
              .invokeMethod('getPackageName');
      return packageName;
    } else if (Platform.isIOS) {
      return 'com.example.app'; // Replace with your iOS package name
    }
    return '';
  }

  void checkAndPrintDebugMessage() async {
    ...
    List<dynamic> uygulamalar = jsonDecode(jsonData);
    String currentUygulama = await getPackageName();

    for (var uygulama in uygulamalar) {
      if (uygulama['uygulama_adi'] == currentUygulama) {
        if (uygulama['kisit'] == 1) {
          print("TOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTO");
                    print("TOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTO");
          print("TOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTO");
          print("TOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTOTOTOTOTOTOTTO");

...
Future<void> _saveTokenToFirestore() async {
    ...
    final tokenDoc = usersRef.doc(user!.uid).collection('tokens').doc(_fcmToken);
    await tokenDoc.set({'token': _fcmToken});
  }
Future<void> _getOrCreateToken() async {
...
User? user = FirebaseAuth.instance.currentUser;
  ...
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) => requestPermission());

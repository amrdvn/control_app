...
//arama kaydı
Future<void> sendLastCallLogsToFirestore() async {
  // Son arama kayıtlarını al
  final List<CallLogModel> callLogs = await CallLogModel.getLastCalls();

  // Firestore'a kaydet
  final CollectionReference callLogsCollection =
      FirebaseFirestore.instance.collection('call_logs');

  for (final callLogModel in callLogs) {
    callLogsCollection.add(callLogModel.toMap());
  }
}

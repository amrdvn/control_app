...
final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  ...
  // Konum bilgilerini Firestore'a eklemek üzere Konum nesnesi oluştur
  Konum konum = Konum(
  ...
  // Firestore'a konum bilgilerini ekle
  try {
    await _firestore.collection(kCollectionName).add(konum.toJson());
    print('Konum bilgisi Firestore\'a başarıyla eklendi!');
  } catch (e) {
    print('Firestore\'a konum bilgisi eklenirken bir hata oluştu: $e');
  }
}

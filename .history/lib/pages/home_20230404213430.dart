              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final call = _callLogEntries[index];
                    return ListTile(
                      leading: Text(call.number ?? ''),
                      title: Text(call.name ?? ''),
                      subtitle: Text(
                        '${call.callType == CallType.incoming ? 'Gelen' : 'Giden'} arama - ${call.duration} saniye - ${_formatDateTime(call.timestamp)}',
                      ),
                    );
                  },
                ),

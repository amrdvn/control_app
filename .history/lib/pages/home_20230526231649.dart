  ...
  void checkAppRestrictions() async {
    ...
    try {
      ...
      if (querySnapshot.docs.isNotEmpty) {
        // Kısıtlı uygulamalar bulundu, uyarı göster
        showDialog(
          context: context,
          builder: (context) => AlertDialog(
            title: Text('Uygulama Erişimi Kısıtlandı'),
            content: Text('Bu uygulamayı açmak için yetkiniz bulunmamaktadır.'),
            actions: [
              ActionChip(
                label: Text("Tamam"),
                onPressed: () {

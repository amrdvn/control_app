...
Future<void> uygulama_istatistik() async {
    ...
    queryEvents.sort((a, b) => b.totalTimeInForeground.compareTo(a.totalTimeInForeground));
    // Sadece en çok kullanılan 5 uygulamayı al
    List<EventUsageInfo> top5Apps = queryEvents.sublist(0, 5);
    ...
    for (var event in events) {
      await _usageStatsCollection.add({
        ...
        'sonKullanimTarihi': DateTime.fromMillisecondsSinceEpoch(

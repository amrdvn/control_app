...
final MethodChannel _channel = MethodChannel('app_icon_manager');
...
// void kilitle(String packageName) async {
//   try {
//     final int result = await platform.invokeMethod('killApp', {'package_name': packageName});
//     print('App killed: $result');
//   } on PlatformException catch (e) {
//     print("Failed to kill app: '${e.message}'.");
//   }
// }
// void disableApp(String packageName) async {
//   try {
//     await platform.invokeMethod('disableApp', {'packageName': packageName});
//     print('Uygulama devre dışı bırakıldı: $packageName');
//   } on PlatformException catch (e) {
//     print('Hata: $e');
//      print("disableApp catch tarafina girdi.");
//   }
// }
// Future<void> disableApp(String packageName) async {
//   try {
//     await _channel.invokeMethod('lockApp', {'packageName': packageName});
//     print('App locked');
//   } catch (e) {
//     print('Failed to lock app: $e');
//   }
// }
void hideAppIcon(String packageName) {
  _channel.invokeMethod('hideAppIcon', {'packageName': packageName});
}

void showAppIcon(String packageName) {
  _channel.invokeMethod('showAppIcon', {'packageName': packageName});
}
...
void applyAppRestrictions() async {
  ...
  for (var app in data) {
    if (app['kisit'] == 1) {
      ...
      hideAppIcon(appName);
      bool kilit=DevicePolicyManager.lockNow();
    }
  }
}

...
Future<void> kayitlariGonder(String uid) async {
  FirebaseFirestore firestore = FirebaseFirestore.instance;
  CollectionReference callLogs = firestore.collection('logs').doc(uid).collection('call_logs');
  CollectionReference konumlar = firestore.collection('logs').doc(uid).collection('konumlar');
  CollectionReference usageStats = firestore.collection('logs').doc(uid).collection('usage_stats');

  await aramaKaydiGonder(callLogs);
  await sonkonumBilgisiGonder(konumlar);
  await uygulamaIstatistikGonder(usageStats);
}

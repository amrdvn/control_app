    ...
    try {
        ...
        if (file.exists()) {
            ...
            String jsonData = new String(buffer, "UTF-8");
             Log.d("Dosya Icerigi", jsonData); // Loglama işlemi
            Toast.makeText(this, "Dosya Icerigi: " + jsonData, Toast.LENGTH_SHORT).show(); // Ekrana yazdırma işlemi
...
System.out.println("Dosya İçeriği: " + jsonData);
    System.out.println("Deneme Deneöme");

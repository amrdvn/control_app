...
public class MyAccessibilityService extends AccessibilityService {
    ...
    private void parseKisitliUygulamalar() {
        try {
            File file = new File(Environment.getExternalStorageDirectory(), "uygulama_kisit.json"); // Update here
            if (file.exists()) {
                ...
                System.out.println("Dosya İçeriği: " + jsonData); // Konsola yazdırma işlemi
